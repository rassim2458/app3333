        ...
        <Stack spacing={2}>
            <Stack p={2} spacing={3} alignItems='start'
             sx={{backgroundColor:theme.palette.background.paper, borderRadius: 1}}>
                ...
                <Typography variant='body2'  color={el.incoming ? theme.palette.text : '#fff'} maxWidth={'300px'} sx={{overflow: 'Hidden',wordBreak: 'break-all'}}>
                    {el.message}
                </Typography>
            </Stack>
        </Stack>
    ...
    <Stack direction='row' justifyContent={el.incoming ? 'start' : 'end'}>
        ...
        <Box >
                        <StyledBadge  >
                            ...
                            <Avatar spacing={1} sx={{height:30, width:30}}alt={faker.name.fullName()} src={faker.image.avatar()} />
                        </StyledBadge>
